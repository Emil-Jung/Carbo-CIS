...
(function () {
  ...
  var LAYOUT = {
    ...
    reportsRow1: ["producers_public", "quality_view", "bag_stock"],
  ...
  function iconSvg(name) {
    ...
    var icons = {
      ...
      bags:
        ...
        '<svg viewBox="0 0 24 24" aria-hidden="true"><path fill="currentColor" d="M8 2h8l2 4h4v2H2V6h4l2-4zm-2 8h12v10H6V10zm2 2v6h8v-6H8z"/></svg>',
  ...
  function renderTile(ui, mod) {
    ...
    var inactive = !!mod.inactive;

    var allowed = inactive || (CIS.canAccessModule ? CIS.canAccessModule(mod) : true);

    var tileClass = "dashboard-tile";

    if (inactive) tileClass += " dashboard-tile-inactive";

    else if (!allowed) tileClass += " dashboard-tile-locked";
    ...
    if (inactive) {
      ...
      tile.appendChild(ui.el("span", { class: "dashboard-tile-lock dashboard-tile-soon" }, ["Coming soon"]));
